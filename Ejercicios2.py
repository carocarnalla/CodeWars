...
### Si ponemos la igualacion directa
...
## Marcando sólo si se encuentra cerrado

di=0
dj=0

def lab(pi, pj, pia, pja,xi,xj,yi,yj,di,dj):
    arriba = l[pi-1][pj]
    abajo = l[pi+1][pj]
    izq = l[pi][pj-1]
    der = l[pi][pj+1]
    ...
    if pi>pia and pj==pja:
        ...
        if izq=='#' and ((der!='#')) and abajo=='#':
            ...
            pia=pi
            pja=pj
            lab(pi,pj+1,pia,pja,xi,xj,yi,yj,di,dj)
            return 0
        ...
        if ((izq=='#')) and (der=='#') and abajo=='#':
            ...
            pj=xj
            l[di][dj]='#'
            lab(pi,pj,pia,pja,xi,xj,yi,yj,di,dj)
            return 0
